...
var CHUNKS = [
  // ── Identity & Bio ──
  { id:'bio', text:'Jugal Gajjar is an AI/ML Engineer and Researcher, and a recent graduate of The George Washington University. He builds production-grade ML and backend systems (microservices with gRPC/NestJS/Docker, low-latency C++, full-stack apps, and applied LLM pipelines such as the live Multimodal AI Intelligence Platform at projectmmap.com) and publishes research on Large Language Models (LLMs), reasoning, trustworthy and explainable AI, and AI for code intelligence and security.', keywords:'who jugal about person bio introduction researcher engineer ml engineer swe software recent graduate mmap projectmmap' },
  ...
  // ── Education ──
  { id:'ms', text:'Jugal recently completed his M.S. in Computer Science (Machine Intelligence and Cognition) at The George Washington University, Washington D.C., graduating in 2026 with a GPA of 3.88/4.0.', keywords:'masters graduate gwu george washington university education degree gpa graduated recent' },
  ...
  // ── Projects ──
  { id:'mmap', text:'Multimodal AI Intelligence Platform (MMAP) is a production full-stack platform for retrieval-augmented chat over text, PDFs, images, audio, and video, with a live knowledge graph, web-search augmentation, and grounded cited answers. FastAPI + async arq workers, Next.js 16, Qdrant/Neo4j/Postgres/Redis, OpenRouter + Groq models. Deployed live at projectmmap.com.', keywords:'mmap multimodal ai intelligence platform projectmmap rag retrieval chat pdf image audio video knowledge graph fastapi nextjs qdrant neo4j langgraph production deployed full-stack flagship recent project' },
  ...
  { id:'projects_all', text:'Jugal has 18 projects: Multimodal AI Intelligence Platform (MMAP), TaskForge, RSAT, ResearchVault, FASS, Adaptive RAG, Cross-Language Vulnerability Lifecycle, HyperComplEx, MLCPD, VulnGraph, Multi-Agent Financial Assistant, SecureFixAgent, OrderBook++, MalCodeAI, Multimodal Sentiment Analysis, SciChat, EzyCart, CryptChat.', keywords:'project projects all list how many count' },
  // ── Publications ──
  { id:'pub_rsat', text:'RSAT: Structured Attribution Makes Small Language Models Faithful Table Reasoners. Authors: Jugal Gajjar, Kamalasankari Subramaniakuppusamy. Accepted at SURGeLLM Workshop ACL 2026.', keywords:'rsat publication paper acl 2026 attribution faithful table reasoning workshop' },
  { id:'pub_fass', text:'FASS: Feature Attribution Stability Suite - How Stable Are Post-Hoc Attributions? Authors: Kamalasankari Subramaniakuppusamy, Jugal Gajjar. Accepted at XAI4CV Workshop CVPR 2026. Evaluates Grad-CAM, IG, GradientSHAP, LIME stability.', keywords:'fass publication paper cvpr 2026 xai attribution stability workshop' },
  ...
  { id:'pubs_all', text:'Jugal has 9 publications and papers: RSAT (ACL 2026), FASS (CVPR 2026), HyperComplEx (IEEE BigData 2025), VulnGraph (Complex Networks 2025), SecureFixAgent (ICMLA 2025), MalCodeAI (IEEE IRI 2025), MLCPD (arXiv cs.SE 2025), Multimodal Sentiment (arXiv cs.CL 2025), Cross-Language Vulnerability thesis.', keywords:'publication paper research conference journal all list how many count' },
  // ── Awards & Service ──
  { id:'awards', text:'Jugal awards: Sustainability Award at Complex Networks 2025, GW Dean\'s Scholarship Award, NVIDIA Jetson AI Specialist, International Karate Gold Medalist representing India at Wado International Karate Championship 2017, Student of the Year three consecutive years grades 8-10, Junior Sports Leader.', keywords:'award awards honors achievements medals scholarships sustainability dean karate' },
  { id:'service', text:'Jugal professional service: Program Committee Member at ACM WSDM 2027, KGBigdata Workshop @ IEEE BigData 2026,s IEEE ICTAI 2026, Reviewer at ICMLA 2026, ICMLA 2025 ROSE-LLM track, IEEE USBEREIT 2026, and ACL 2026 (GEM Workshop, SURGeLLM Workshop, CDL Workshop).', keywords:'service reviewer program committee ieee ictai icmla gem surgellm cdl professional' },
  // ── Skills ──
  { id:'skills', text:'Programming: Python, Java, C++, TypeScript/JavaScript. ML/AI: PyTorch, TensorFlow, LangChain/LangGraph, HuggingFace Transformers, PyTorch Geometric, Apple MLX, sentence-transformers. Areas: NLP, LLMs, RAG, GNNs, Knowledge Graphs, Reinforcement Learning, Explainable AI, Trustworthy AI, Computer Vision, Deep Learning. Backend and systems: FastAPI, NestJS, Flask, gRPC, microservices, async workers. Frontend: Next.js, React. Data stores: PostgreSQL, Qdrant, Neo4j, Redis, OpenSearch. Tools and infra: SQL, Git, Docker, Spark, Hadoop, AWS S3, Cloudflare R2, CI/CD.', keywords:'skill skills tech stack tools programming python pytorch llm nlp gnn graph fastapi nextjs react typescript microservices docker backend frontend engineering' },
  // ── Personal & Contact ──
  ...
  { id:'location', text:'Jugal is from Vadodara, India, and is based in the Washington D.C. area, where he recently completed his M.S. at The George Washington University.', keywords:'location where from live based country city vadodara india washington dc' },
  { id:'current', text:'Jugal recently completed his M.S. at GWU and is building and shipping production AI systems, most notably the Multimodal AI Intelligence Platform (live at projectmmap.com), alongside research with recent papers accepted at ACL 2026 (RSAT) and CVPR 2026 (FASS). He is open to AI/ML engineering, software engineering, and research/PhD opportunities.', keywords:'currently now doing present today active working recent graduate mmap projectmmap open opportunities hiring' },
];
